<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="EquipActivo.aspx.vb" Inherits="_EquipActivo" %>

<%@ Register src="cti/wucClasesA.ascx" tagname="wucClasesA" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="izquierdo" class="auto-style20">
        ...
        <asp:GridView ID="GridView1" runat="server" 
            DataKeyNames ="idactivo" AutoGenerateColumns="False" CellPadding="4" 
            ForeColor="#333333" GridLines="None" Width="464px">
            <Columns>
                <asp:BoundField DataField="idactivo" ItemStyle-Width="1" ItemStyle-Font-Size="1" >
<ItemStyle Font-Size="1pt" Width="1px"></ItemStyle>
    ...
    <div id="derecho" class="auto-style24">
        <table class="auto-style1">
            <tr>
                <td colspan="2">
                    <h4 class="auto-style9">
                        Editar registro de Equipos Activos</h4>
                </td>
            ...
            <tr>
                <td class="auto-style25">Activo:<br />
                    <asp:TextBox ID="TxtClave" runat="server" CssClass="txtCaptura" MaxLength="40" Width="189px" /></td>
                <td class="auto-style26">Puesto:<br />
                    <uc1:wucClasesA ID="wucClasesA" runat="server" /></td>  
            </tr>
