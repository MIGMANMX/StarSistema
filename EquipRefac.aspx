<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="EquipRefac.aspx.vb" Inherits="_EquipRefac" %>
<%@ Register src="cti/wucEquipActivo.ascx" tagname="wucEquipActivo" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="izquierdo" class="auto-style20">
        ...
        <asp:GridView ID="GridView1" runat="server" 
            DataKeyNames ="idrefacc" AutoGenerateColumns="False" CellPadding="4" 
            ForeColor="#333333" GridLines="None" Width="464px">
            <Columns>
                <asp:BoundField DataField="idrefacc" ItemStyle-Width="1" ItemStyle-Font-Size="1" >
<ItemStyle Font-Size="1pt" Width="1px"></ItemStyle>
               ...
               <asp:BoundField DataField="refacc" HeaderText="Refacción" SortExpression="refacc" />   
    ...
    <div id="derecho" class="auto-style24">
        <table class="auto-style1">
            <tr>
                <td colspan="2">
                    <h4 class="auto-style9">
                        Editar registro de Refacciones</h4>
                </td>
            ...
            <tr>
                <td class="auto-style25">Refacciones:<br />
                    <asp:TextBox ID="TxtClave" runat="server" CssClass="txtCaptura" MaxLength="40" Width="189px" /></td>
                <td class="auto-style26">Activo:<br />
                    <uc1:wucEquipActivo ID="wucEquipActivo" runat="server" /></td>  
            </tr>
