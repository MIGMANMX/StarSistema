...
Partial Class _ClasesdeCajaChica
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            GridView1.DataSource = gvds.gvClasesCajaChica
            gvds = Nothing
            GridView1.DataBind()
        End If
        Lmsg.Text = "" : gvPos = 0
        If Request.Form("btnSi") <> "" Then
            ...
            Dim err As String = ep.eliminarClasesCajaChica(CInt(Session("idz_e").ToString))
            GridView1.DataSource = ep.gvClasesCajaChica()
            ep = Nothing
            GridView1.DataBind()
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf e.CommandName = "Editar" Then
            ...
            Dim datos() As String = dsP.datosClasesCajaChica(CInt(GridView1.Rows(Convert.ToInt32(e.CommandArgument)).Cells(0).Text))
            dsP = Nothing
    ...
    Protected Sub btnActualizar_Click(sender As Object, e As EventArgs) Handles btnActualizar.Click
        ...
        Else
            ...
            Dim r As String = ap.actualizarClasesCajaChica(idA, TxtClase.Text, TxtClave.Text)
            GridView1.DataSource = ap.gvClasesCajaChica()
            ap = Nothing
            GridView1.DataBind()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        Else
            ...
            Dim r() As String = gp.agregarClasesCajaChica(TxtClase.Text, TxtClave.Text)
            GridView1.DataSource = gp.gvClasesCajaChica()
            gp = Nothing
            GridView1.DataBind()
