...
Partial Class _ProveedorGastos
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            GridView1.DataSource = gvds.gvProveedorGastos
            gvds = Nothing
            GridView1.DataBind()
        End If
        Lmsg.Text = "" : gvPos = 0
        If Request.Form("btnSi") <> "" Then
            ...
            Dim err As String = ep.eliminarProveedorGastos(CInt(Session("idz_e").ToString))
            GridView1.DataSource = ep.gvProveedorGastos()
            ep = Nothing
            GridView1.DataBind()
    ...
    Protected Sub btnActualizar_Click(sender As Object, e As EventArgs) Handles btnActualizar.Click
        ...
        Else
            ...
            Dim _contacto3 As String
            If TxtContacto3.Text <> "" Then
                _contacto3 = Convert.ToString(TxtContacto3.Text)
            Else
                _contacto3 = " "
            End If
            ...
            Dim _numero3 As String
            If TxtNumero3.Text <> "" Then
                _numero3 = Convert.ToString(TxtNumero3.Text)
            Else
                _numero3 = " "
            End If
            ...
            Dim r As String = ap.actualizarProveedorGastos(idA, TxtProveedor.Text, _cuenta, _numero, _numero2, _numero3, _contacto1, _contacto2, _contacto3, _diacredito, _limite, _diapago)
            GridView1.DataSource = ap.gvProveedorGastos()
            ap = Nothing
            GridView1.DataBind()
            ...
            Else
                ...
                TxtContacto2.Text = "" : TxtProveedor.Text = "" : TxtNumero3.Text = "" : TxtContacto3.Text = ""
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        Else
            ...
            Dim r() As String = gp.agregarProveedorGastos(TxtProveedor.Text, _cuenta, _numero, _numero2, _numero3, _contacto1, _contacto2, _contacto3, _diacredito, _limite, _diapago)
            GridView1.DataSource = gp.gvProveedorGastos()
            gp = Nothing
            GridView1.DataBind()
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf e.CommandName = "Editar" Then
            ...
            Dim datos() As String = dsP.datosProveedorGastos(CInt(GridView1.Rows(Convert.ToInt32(e.CommandArgument)).Cells(0).Text))
            dsP = Nothing
            ...
            Else
                ...
                TxtNumero3.Text = datos(4)
                TxtContacto1.Text = datos(5)
                TxtContacto2.Text = datos(6)
                TxtContacto3.Text = datos(7)
                TxtDias.Text = datos(8)
                TxtLimite.Text = datos(9)
                TxtDiaspago.Text = datos(10)
