...
Partial Class _Clases
    ...
    Protected Sub btnActualizar_Click(sender As Object, e As EventArgs) Handles btnActualizar.Click
        'If TxtClase.Text = "" And Txtclave.Text = "" And TxtCosto.Text = "" Then
        ...
        '    Dim r As String = ap.actualizarProductos(idA, TxtClase.Text, Txtclave.Text, TxtCosto.Text)
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        '        Dim r() As String = gp.agregarProductos(TxtClase.Text, Txtclave.Text, TxtCosto.Text)
