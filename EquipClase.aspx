<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="EquipClase.aspx.vb" Inherits="_EquipClase" %>
...
<ItemStyle Font-Size="1pt" Width="1px"></ItemStyle>
    ...
    <div id="derecho" class="auto-style24">
        <table class="auto-style1">
            <tr>
                <td colspan="2">
                    <h4 class="auto-style9">
                        Editar registro de Clases Activos</h4>
                </td>
            ...
            <tr>
                <td class="auto-style25">Clases Activos:<br />
