<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="ConfiSucursales.aspx.vb" Inherits="_ConfiSucursales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="izquierdo" class="auto-style20">
        ...
        <asp:GridView ID="GridView1" runat="server" 
            DataKeyNames ="idsucursal" AutoGenerateColumns="False" CellPadding="4" 
            ForeColor="#333333" GridLines="None" Width="464px">
            <Columns>
                <asp:BoundField DataField="idsucursal" ItemStyle-Width="1" ItemStyle-Font-Size="1" >
<ItemStyle Font-Size="1pt" Width="1px"></ItemStyle>
               ...
               <asp:BoundField DataField="sucursal" HeaderText="Sucursal" SortExpression="sucursal" />     
                <asp:BoundField DataField="prorrateo" HeaderText="Prorrateo %" SortExpression="prorrateo" />     
            ...
            <tr>
                <td colspan="2">
                    <h4 class="auto-style9">
                        Editar registro de Conceptos de Sucursales</h4>
                </td>
