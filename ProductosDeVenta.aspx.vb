...
Partial Class _ProductosDeVenta
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            GridView1.DataSource = gvds.gvProductos
            gvds = Nothing
            GridView1.DataBind()
        End If
        Lmsg.Text = "" : gvPos = 0
        If Request.Form("btnSi") <> "" Then
            ...
            Dim err As String = ep.eliminarProductos(CInt(Session("idz_e").ToString))
            GridView1.DataSource = ep.gvProductos()
            ep = Nothing
            GridView1.DataBind()
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf e.CommandName = "Editar" Then
            ...
            Dim datos() As String = dsP.datosProductos(CInt(GridView1.Rows(Convert.ToInt32(e.CommandArgument)).Cells(0).Text))
            dsP = Nothing
    ...
    Protected Sub btnActualizar_Click(sender As Object, e As EventArgs) Handles btnActualizar.Click
        If TxtInsumo.Text = "" And Txtclave.Text = "" And TxtCosto.Text = "" Then
        ...
        Else
            ...
            Dim r As String = ap.actualizarProductos(idA, TxtInsumo.Text, Txtclave.Text, TxtCosto.Text)
            GridView1.DataSource = ap.gvProductos()
            ap = Nothing
            GridView1.DataBind()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        Else
            ...
            Dim r() As String = gp.agregarProductos(TxtInsumo.Text, Txtclave.Text, TxtCosto.Text)
            GridView1.DataSource = gp.gvProductos()
            gp = Nothing
            GridView1.DataBind()
