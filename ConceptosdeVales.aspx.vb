...
Partial Class _ConceptosdeVales
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            GridView1.DataSource = gvds.gvConceptosdeVales
            gvds = Nothing
            GridView1.DataBind()
        End If
        Lmsg.Text = "" : gvPos = 0
        If Request.Form("btnSi") <> "" Then
            ...
            Dim err As String = ep.eliminarConceptosdeVales(CInt(Session("idz_e").ToString))
            GridView1.DataSource = ep.gvConceptosdeVales()
            ep = Nothing
            GridView1.DataBind()
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf e.CommandName = "Editar" Then
            ...
            Dim datos() As String = dsP.datosConceptosdeVales(CInt(GridView1.Rows(Convert.ToInt32(e.CommandArgument)).Cells(0).Text))
            dsP = Nothing
    ...
    Protected Sub btnActualizar_Click(sender As Object, e As EventArgs) Handles btnActualizar.Click
        ...
        Else
            ...
            Dim r As String = ap.actualizarConceptosdeVales(idA, TxtClave.Text)
            GridView1.DataSource = ap.gvConceptosdeVales()
            ap = Nothing
            GridView1.DataBind()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        Else
            ...
            Dim r() As String = gp.agregarConceptosdeVales(TxtClave.Text)
            GridView1.DataSource = gp.gvConceptosdeVales()
            gp = Nothing
            GridView1.DataBind()
