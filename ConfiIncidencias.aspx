<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="ConfiIncidencias.aspx.vb" Inherits="_ConfiIncidencias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h3>Conceptos de Incidencias</h3>
    <div id="izquierdo" class="auto-style20">
        ...
        <asp:GridView ID="GridView1" runat="server" 
            DataKeyNames ="idincidencia" AutoGenerateColumns="False" CellPadding="4" 
            ForeColor="#333333" GridLines="None" Width="464px">
            <Columns>
                <asp:BoundField DataField="idincidencia" ItemStyle-Width="1" ItemStyle-Font-Size="1" >
<ItemStyle Font-Size="1pt" Width="1px"></ItemStyle>
    ...
    <div id="derecho" class="auto-style24">
        <table class="auto-style1">
            <tr>
                <td colspan="2" class="auto-style27">
                    <h4 class="auto-style9">
                        Editar registro de Conceptos de Incidencias</h4>
                </td>
            ...
            <tr>
                <td class="auto-style25">Incidencia:<br />
