<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="ConfiDiscrepancia.aspx.vb" Inherits="_ConfiDiscrepancia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h3>Conceptos de Discrepancia</h3>
    <div id="izquierdo" class="auto-style20">
        ...
        <asp:GridView ID="GridView1" runat="server" 
            DataKeyNames ="iddiscrepancia" AutoGenerateColumns="False" CellPadding="4" 
            ForeColor="#333333" GridLines="None" Width="464px">
            <Columns>
                <asp:BoundField DataField="iddiscrepancia" ItemStyle-Width="1" ItemStyle-Font-Size="1" >
<ItemStyle Font-Size="1pt" Width="1px"></ItemStyle>
               ...
               <asp:BoundField DataField="discrepancia" HeaderText="Discrepancia" SortExpression="discrepancia" />     
            ...
            <tr>
                <td colspan="2">
                    <h4 class="auto-style9">
                        Editar registro de Conceptos de Discrepancia</h4>
                </td>
