...
Partial Class _EquipActivo
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            GridView1.DataSource = gvds.gvEquipActivo
            gvds = Nothing
            GridView1.DataBind()
        End If
        Lmsg.Text = "" : gvPos = 0
        If Request.Form("btnSi") <> "" Then
            ...
            Dim err As String = ep.eliminarEquipActivo(CInt(Session("idz_e").ToString))
            GridView1.DataSource = ep.gvEquipActivo()
            ep = Nothing
            GridView1.DataBind()
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf e.CommandName = "Editar" Then
            ...
            Dim datos() As String = dsP.datosEquipActivo(CInt(GridView1.Rows(Convert.ToInt32(e.CommandArgument)).Cells(0).Text))
            dsP = Nothing
    ...
    Protected Sub btnActualizar_Click(sender As Object, e As EventArgs) Handles btnActualizar.Click
        ...
        Else
            ...
            Dim r As String = ap.actualizarEquipActivo(idA, TxtClave.Text, wucClasesA.idClase)
            GridView1.DataSource = ap.gvEquipActivo()
            ap = Nothing
            GridView1.DataBind()
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        Else
            ...
            Dim r() As String = gp.agregarEquipActivo(TxtClave.Text, wucClasesA.idClase)
            GridView1.DataSource = gp.gvEquipActivo()
            gp = Nothing
            GridView1.DataBind()
