<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="ProveedorCompras.aspx.vb" Inherits="_ProveedorCompras" %>
...
<ItemStyle Font-Size="1pt" Width="1px"></ItemStyle>
    ...
    <div id="derecho">
        <table class="auto-style1">
            <tr>
                <td colspan="2">
                    <h4 class="auto-style9">
                        Editar Proveedor de Compras</h4>  </td>
            ...
            <tr>
                <td class="auto-style3">Razon social:<br />
                    <asp:TextBox ID="TxtRazon" runat="server" CssClass="txtCaptura" MaxLength="40" Width="304px" /></td>
                <td class="auto-style11">Cuenta:<br />
